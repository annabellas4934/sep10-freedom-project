...
## Content:
Now that we have all the information we need for the project, we need to start setting up the website. We learned how to wireframe a website and how to use bootstrap. To add more details, we were tasked to learn a new tool, this time with little to no help. We were on our own to learn this new way to code. We had a variety of options. I chose bulma because it didn’t seem difficult to learn since it's similar to bootstrap. I decided I wanted to try to learn 4 different components that bulma had and looked like I would use. When trying out the actual code I figured out that there were some limitations that made it difficult to use for my website. I had very few issues with navigating [breadcrumb](https://bulma.io/documentation/components/breadcrumb/) it's very straight forward. [pagination](https://bulma.io/documentation/components/pagination/) was also pretty easy despite it using a lot of code. Whatever is active is blue and to make it active it is using a class so it's easy to rearrange. I wanted to use [modal](https://bulma.io/documentation/components/modal/) but realized that requires me to use java script.

<img src="bulmablog5.png">
This is an example of me attempting to use a [card](https://bulma.io/documentation/components/card/) format that bulma offers. I was adjusting the image size to see if I can control how large it was in the card to which it was unsuccessful. What did work was using the given dimensions Bulma gives you for images.
